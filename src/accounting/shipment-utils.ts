...
export function calcPrecioBs(p: ShipmentProduct, tc_paralelo: number): number {
  // Si el usuario ingresó el precio Bs pagado, es la fuente de verdad exacta.
  // Recalcular desde tc_producto introduce error de redondeo (tc tiene solo 4 decimales).
